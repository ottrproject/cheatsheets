...
The idea is to **test your code as you develop it** and to automatically deliver or deploy your code. 
...
CI/CD typically uses other infrastructure, such as documentation, version control, and containers or virtual machines.
...
```{r, fig.align='center', out.width="60%", echo = FALSE, fig.alt= "problems accumulate without CICD"}
