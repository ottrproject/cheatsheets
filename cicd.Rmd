...
- CI/CD typically uses other infrastructure, such as version control
(version control is the process of tracking changes over time)
  - There are several tools for version control, but [GitHub](https://github.com/) is one of the most common
- Lab members need to know what working standards are required
  - Onboarding documents like these can help: 
    - https://fertiglab.github.io/onboarding/
    - https://lcolladotor.github.io/bioc_team_ds/onboarding.html
