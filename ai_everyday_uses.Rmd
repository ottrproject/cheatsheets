...
-   Generating hypotheses <br> [(See this example)](https://d2h2.maayanlab.cloud/)
-   Mining the literature for research ideas <br> [(See this example)](https://www.researchrabbit.ai/)
...
-   Creating lab document drafts
    -   Code of conduct <br> [(See this resource)](https://www.caseiq.com/resources/18-of-the-best-code-of-conduct-examples)
    -   Mentee Agreement <br> [(See this resource)](https://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1005709)
    -   Lab Handbook<br> [(See this example)](https://fertiglab.github.io/onboarding/)
:::
:::::
