...
1) Giving credit for people's work is hard
2) Data privacy is tricky
3) Environmental Impact should be considered
4) Using AI too much might degrade your trust in yourself
5) Bias - even simple AI requests can generate biased responses

Credit and Privacy: Be transparent and specific about AI use, Choose models that are more transparent about how they were trained. Shop around!
Environmental Impact is very real: Choose AI tools that are transparent about resource usage and attempts to improve efficiency, consider when AI might not be needed.
