...
ottrpal::borrow_chapter(
  ...
  tag_replacement = list(
    "{TITLE}" = "OTTR Token/Secret", "{SUBTITLE}" =  "Set Up or Update",
        "{PATH_TO_PNG}" = "https://github.com/ottrproject/cheatsheets/blob/main/pngs/ottr_website.png?raw=true"
    ))
```
...
ottrpal::borrow_chapter(
  ...
  tag_replacement = list(
    ...
    "{TEMPLATE_URL}" = "https://github.com/ottrproject/OTTR_Template_Website"))
```
