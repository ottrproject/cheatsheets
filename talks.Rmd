...
&ensp; <input type="checkbox"> Determine the time limit required. 

&ensp; <input type="checkbox">  Draft slides according to the time limit. 
...
&ensp; <input type="checkbox">  Check for language clarity.

&ensp; <input type="checkbox">  Check that fonts are large enough, size 18 or larger is often recommended.

&ensp; <input type="checkbox">  Check that figures are large enough and aren't blurry. 
  
&ensp; (You might need to use a higher quality or larger image.)

&ensp; <input type="checkbox">  Check that all jargon is explained (outside of what is broadly typical).

&ensp; <input type="checkbox">  Check that all acronyms are spelled out the first time.

&ensp; <input type="checkbox"> Check that images cite sources if not original.

**Practice your talk**

&ensp; <input type="checkbox"> Practice giving your talk and adjust to fit the time limit. 
  
&ensp; (Even if just practicing by yourself!)

&ensp; <input type="checkbox">  Get feedback from others where possible (including your PI and lab mates). Be prepared to iterate and change your talk several times.
...
&ensp; <input type="checkbox">  Include your contact information, so others can reach out.

If it is OK with your PI: 

&ensp; <input type="checkbox"> _Optional_: Consider adding your talk to your professional website.

&ensp; <input type="checkbox"> _Optional_: Include a link or QR code so others can find your talk easily! 
Tools like [Bitly](https://app.bitly.com/) can help!)
