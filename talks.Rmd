...
<input type="checkbox"> Make it easy for people to reach out



1. <input type="checkbox">  Optional: Include a link or QR code so others can find your talk easily! (Only if it is OK with your PI.)
